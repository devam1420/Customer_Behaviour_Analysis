...
RENAME COLUMN "Empty" TO "Previous Purchases";
...
SELECT
    ...
    "Previous Purchases",
    CASE
        WHEN CAST("Previous Purchases" AS INTEGER) = 1 THEN 'New'
        WHEN CAST("Previous Purchases" AS INTEGER) BETWEEN 2 AND 10 THEN 'Returning'
        ELSE 'Loyal'
...
FROM customer
WHERE CAST("Previous Purchases" AS INTEGER) >= 5
GROUP BY "Subscription Status";
